...
"""
문제를 봤을때 뭐 이런게 문제야? 하면서 너무 쉽게 생각했는데
막상 풀어보니 안된다.
무조건 N(666)
인줄 알았는데 N번째로 작은 종말의 숫자 란다.
그러면 666 -> 1666 -> 2666 -> 3666 -> 4666 ->5666 -> 6660 이 되야하는 것이다!
이게 말인지 방구인지 숌 붙잡아다가 물어봐야겠다. 
"""
